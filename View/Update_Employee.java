...
public class Update_Employee extends JFrame implements ActionListener,ItemListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b1){
            ...
            String e = t6.getText();
            String p = t7.getText();
            boolean bo= Update_Employee_Controller.Update_Employee(n,g,a,s,c,e,p,c2.getSelectedItem());
            JOptionPane.showMessageDialog(null,"Employee Updated"); //Imp
        }

        if(ae.getSource()==b2){
            boolean bo= Update_Employee_Controller.Update_Employee_Delete(c2.getSelectedItem());
    ...
    public void itemStateChanged(ItemEvent ie){
        try{
            ResultSet rs= Update_Employee_Controller.Update_Employee_Select(c2.getSelectedItem());
            if(rs.next()){
