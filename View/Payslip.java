...
import MVC.com.Controller.Payslip_Controller;
...
public class Payslip extends JFrame implements ActionListener{
    ...
    Payslip(){
        ...
        c1 = new Choice();
        try{
            ResultSet rs= Payslip_Controller.Payslip_Controller();
            while(rs.next()){
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try{
            ResultSet rs1= Payslip_Controller.Payslip_Controller1(c1.getSelectedItem());
            rs1.next();
            String name = rs1.getString("name");
            rs1.close();

            ResultSet rs= Payslip_Controller.Payslip_Controller2(c1.getSelectedItem());
